        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-5 gap-8">
          ...
          <div className="card w-full h-100 text-center hover:bg-base-300 shadow-2xl">
            ...
            <div className="m-2">
              ...
              <div className="card-action m-2">
                <div className="">
                  <button className="">
                    <a href="https://github.com/grsagor" alt="">
                      <FaGithub className="w-7 h-7 my-2 mx-3"></FaGithub>
                    </a>
                  </button>
                  <button className="">
                    <a href="https://www.linkedin.com/in/golam-rahman-sagor-937450217/">
                      <FaLinkedin className="w-7 h-7 my-2 mx-3"></FaLinkedin>
                    </a>
                  </button>
                  <button className="">
                    <a href="https://www.facebook.com/grsagor.official">
                      <FaFacebook className="w-7 h-7 my-2 mx-3"></FaFacebook>
                    </a>
                  </button>
                </div>
                <button className="btn btn-outline btn-secondary rounded-full">
                  <a href={pdf1} download={"Golam Rahman Sagor"}>
                    Get Resume
                  </a>
                </button>
          ...
          <div className="card w-full h-100 text-center hover:bg-base-300 shadow-2xl">
            ...
            <div className="m-2">
              ...
              <p className="text-xl">MERN-developer</p>
              <div className="card-action m-2">
                <div className="">
                  <button className="">
                    <a href="https://github.com/nusratnova5">
                      <FaGithub className="w-7 h-7 my-2 mx-3"></FaGithub>
                    </a>
                  </button>
                  <button className="">
                    <a href="https://www.linkedin.com/in/nusrat-jahan-19311025a/">
                      <FaLinkedin className="w-7 h-7 my-2 mx-3"></FaLinkedin>
                    </a>
                  </button>
                  <button className="">
                    <a href="https://www.facebook.com/nusrat.nova.9216">
                      <FaFacebook className="w-7 h-7 my-2 mx-3"></FaFacebook>
                    </a>
                  </button>
                </div>
                <button className="btn btn-outline btn-secondary rounded-full">
                  <a href={pdf2} download={"Nusrat Jahan"}>
                    Get Resume
                  </a>
                </button>
                {/* <button className="btn btn-outline btn-secondary"><Link to='/'>Visit</Link></button> */}
          ...
          <div className="card w-full h-100 text-center hover:bg-base-300 shadow-2xl">
            ...
            <div className="m-2">
              ...
              <div className="card-action m-2">
                ...
                <div className="">
                  <button className="">
                    <a href="https://github.com/SharminAkter3">
                      <FaGithub className="w-7 h-7 my-2 mx-3"></FaGithub>
                    </a>
                  </button>
                  <button className="">
                    <a href="https://www.linkedin.com/in/sharmin-akter-2b52a6244/">
                      <FaLinkedin className="w-7 h-7 my-2 mx-3"></FaLinkedin>
                    </a>
                  </button>
                  <button className="">
                    <a href="https://www.facebook.com/profile.php?id=100050369974905">
                      <FaFacebook className="w-7 h-7 my-2 mx-3"></FaFacebook>
                    </a>
                  </button>
                </div>
                <button className="btn btn-outline btn-secondary rounded-full">
                  <a href={pdf3} download={"sharmin Akter"}>
                    Get Resume
                  </a>
                </button>
              </div>
            ...
            <div className="m-2">
              ...
              <div className="card-action m-2">
                <div className="">
                  ...
                  <button className="">
                    <a href="https://www.linkedin.com/in/md-shimul-molla-03b8b2259/">
                      <FaLinkedin className="w-7 h-7 my-2 mx-3"></FaLinkedin>
                    </a>
                  </button>
                  <button className="">
                    <a href="https://www.facebook.com/mesultan.mahmud">
                      <FaFacebook className="w-7 h-7 my-2 mx-3"></FaFacebook>
                    </a>
                  </button>
                </div>
                <button className="btn btn-outline btn-secondary rounded-full">
                  <a href={pdf4} download={"Md Shimul Molla"}>
                    Get Resume
                  </a>
                </button>
                {/* <button className="btn btn-outline btn-secondary"><Link to='/'>Visit</Link></button> */}
          ...
          <div className="card w-full h-100 text-center hover:bg-base-300 shadow-2xl">
            ...
            <div className="m-2">
              ...
              <div className="card-action m-2">
                <div className="">
                  <button className="">
                    <a href="https://github.com/anichu">
                      <FaGithub className="w-7 h-7 my-2 mx-3"></FaGithub>
                    </a>
                  </button>
                  <button className="">
                    <a href="https://www.linkedin.com/in/md-anis-molla-19515417b/">
                      <FaLinkedin className="w-7 h-7 my-2 mx-3"></FaLinkedin>
                    </a>
                  </button>
                  <button className="">
                    <a href="https://www.facebook.com/mdanis.molla.750983">
                      <FaFacebook className="w-7 h-7 my-2 mx-3"></FaFacebook>
                    </a>
                  </button>
                </div>
                <button className="btn btn-outline btn-secondary rounded-full">
                  <a href={pdf5} download={"Md Anis Molla"}>
                    Get Resume
                  </a>
                </button>
                {/* <button className="btn btn-outline btn-secondary"><Link to='/'>Visit</Link></button> */}
          ...
          <div className="card w-full h-100 text-center hover:bg-base-300 shadow-2xl">
            ...
            <div className="m-2">
              ...
              <div className="card-action m-2">
                ...
                <button className="btn btn-outline btn-secondary rounded-full">
                  <a href={pdf6} download={"Md Mahmudul Hasan"}>
                    Get Resume
                  </a>
                </button>
                {/* <button className="btn btn-outline btn-secondary"><Link to='/'>Visit</Link></button> */}
